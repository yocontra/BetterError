...
function BetterError(plugin, message, opt) {
  if (!(this instanceof BetterError)) throw new Error('Call BetterError using new');
...
BetterError.prototype.toString = function () {
  var sig = '['+chalk.green('gulp')+'] '+this.name+' in plugin \''+chalk.cyan(this.plugin)+'\'';
